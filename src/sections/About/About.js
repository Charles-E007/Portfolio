        ...
        _jsxs("defs", {
          children: [
            _jsxs("linearGradient", {
              ...
              children: [
                _jsx("stop", { stopColor: "#3D2E00" }),
                _jsx("stop", { stopColor: "#6B5000", offset: 1 }),
              ],
            }),
            _jsxs("linearGradient", {
              gradientUnits: "userSpaceOnUse",
              ...
              children: [
                _jsx("stop", { stopColor: "#6B5000" }),
                _jsx("stop", { stopColor: "#3D2E00", offset: "0.29" }),
                _jsx("stop", { stopColor: "#B8860B", offset: 1 }),
              ],
            }),
            _jsxs("linearGradient", {
              gradientUnits: "userSpaceOnUse",
            ...
            _jsxs("linearGradient", {
              ...
              children: [
                _jsx("stop", { stopColor: "#B8860B" }),
                _jsx("stop", { stopColor: "#FFD700", offset: 1 }),
              ],
            }),
            _jsxs("linearGradient", {
              gradientUnits: "userSpaceOnUse",
...
export default function About() {
  return _jsx("section", {
    ...
    children: _jsxs("div", {
      className:
        "relative z-10 w-full max-w-screen-xl mx-auto px-4 sm:px-6 py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16",
      children: [
        _jsxs("div", {
          className: "flex-1 flex flex-col gap-6 md:gap-10 w-full",
          children: [
            _jsxs("div", {
              children: [
                _jsxs(motion.h2, {
                  className:
                    "text-[clamp(2.5rem,8vw,6.5rem)] leading-[0.9] uppercase text-[var(--color-primary)]",
                ...
                _jsx(motion.div, {
                  className:
                    "w-16 md:w-24 h-[3px] bg-[var(--color-primary)] mt-3",
                  initial: { scaleX: 0 },
            ...
            _jsxs(motion.p, {
              className:
                "text-[clamp(1.05rem,2.5vw,1.65rem)] leading-snug uppercase text-[var(--color-text)] max-w-2xl",
              style: { fontFamily: "var(--font-display)" },
              ...
              children: [
                ...
                _jsx("span", {
                  ...
                  children: "Charles Emmanuel",
                }),
                ",",
                " ",
                "d\u00E9veloppeur Full-Stack et passionn\u00E9 de code et d'innovation. Je transforme vos probl\u00E8mes en",
                " ",
                _jsx("span", {
                  className: "text-[var(--color-primary)]",
                  children: "solution digitale innovante",
                }),
                ". Je con\u00E7ois des applications web et mobile performantes, de l'interface jusqu'au serveur.",
              ],
            }),
            _jsxs(motion.a, {
        ...
        _jsx(motion.div, {
          className:
            "flex-1 flex items-center justify-center w-full mt-6 md:mt-0 min-h-[220px] md:min-h-0",
          ...
          children: _jsxs("div", {
            ...
            children: [
              _jsx("div", {
                className:
                  "absolute inset-0 blur-3xl bg-[var(--color-primary)]/15 rounded-full scale-120 md:scale-150",
              }),
              _jsx("div", {
                className:
                  "relative scale-[1.5] sm:scale-[2.2] md:scale-[3] transition-transform duration-300",
