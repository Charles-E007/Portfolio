// src/components/ui/VideoText.tsx
import { cn } from "../../lib/utils"   // ← chemin adapté à ton projet
...
export function VideoText({
  ...
  const MotionComponent = motion[validTags.includes(as as ValidTag) ? (as as ValidTag) : "div"] as any
